...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        //get UOMs
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        System.out.println("ID:" + eachUomOptional.get().getId());
        System.out.println(eachUomOptional.isPresent());
        ...
        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Pinch");
